...
vgaBus = Mios.AvalonMMInterface(sys, 'vga_bus')
...
vga = VGAText(sys, 'sev', vgaBus)


avalonDecoder = Mios.AvalonMMDecoder(sys, 'decoder', cpuBus, 
                              [insBus, perfBus, dataBus, vgaBus],
                              [0,  0x21040, 0x4000, 0xB8000],
                              [0x400 * 8,  32, 0x400 * 8, 80*25*2])
...
hfp.loadMem('software/testVGAText/testVGAText.hex', insMem, 0x0)
