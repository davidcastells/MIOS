...
sevBus = Mios.AvalonMMInterface(sys, 'sev_bus')
...
sev = SevenSegmentsSlaveDevice(sys, 'sev', sevBus)


avalonDecoder = Mios.AvalonMMDecoder(sys, 'decoder', cpuBus, 
                              [insBus, perfBus, dataBus, sevBus],
                              [0,  0x21040, 0x4000, 0x21200],
                              [0x400 * 8,  32, 0x400 * 8, 32])
...
hfp.loadMem('software/testLEDBus/testLEDBus.hex', insMem, 0x0)
